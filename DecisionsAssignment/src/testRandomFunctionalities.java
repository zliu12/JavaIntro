...
public class testRandomFunctionalities {
  public static void main(String[] args) {
    ...
    // Test Method putTogether
		// popeyes
    System.out.println("pop, eyes: " + test.putTogether("pop", "eyes"));
		// rescuelephant
		System.out.println("rescue, elephants: " + test.putTogether("rescue", "elephants"));
		// Javapple
		System.out.println("Java, apple: " + test.putTogether("Java", "apple"));
